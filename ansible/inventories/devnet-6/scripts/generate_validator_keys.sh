...
function prep_group {
  ...
  genesis_root=$(cat ../../../../network-configs/devnet-6/parsedBeaconState.json| jq -r .genesis_validators_root)
  genesis_version=$(cat ../../../../network-configs/devnet-6/config.yaml| yq .GENESIS_FORK_VERSION)
...
prep_group 1 "$VALIDATORS_MNEMONIC_0" 0 1 "lodestar-ethereumjs" 64 # 0 - 63
prep_group 1 "$VALIDATORS_MNEMONIC_0" 1 1 "lodestar-nethermind" 64 # 64 - 127
prep_group 1 "$VALIDATORS_MNEMONIC_0" 2 1 "lodestar-besu" 64 # 128 - 191
prep_group 1 "$VALIDATORS_MNEMONIC_0" 3 1 "teku-ethereumjs" 64 # 192 - 255
prep_group 1 "$VALIDATORS_MNEMONIC_0" 4 1 "teku-nethermind" 64 # 256 - 319
prep_group 1 "$VALIDATORS_MNEMONIC_0" 5 1 "teku-besu" 64 # 320 - 383
