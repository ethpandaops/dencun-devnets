...
terraform {
  backend "s3" {
    ...
    key                         = "infrastructure/dencun-gsf-2/terraform.tfstate"
  }
}
...
locals {
  ...
  digitalocean_default_size   = "so1_5-4vcpu-32gb"
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "../../ansible/inventories/gsf-2/inventory.ini"
}
