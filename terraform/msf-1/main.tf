...
terraform {
  backend "s3" {
    ...
    key                         = "infrastructure/dencun-msf-1/terraform.tfstate"
  }
}
...
locals {
  ...
  digitalocean_default_size   = "so1_5-8vcpu-64gb"
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "../../ansible/inventories/msf-1/inventory.ini"
}
