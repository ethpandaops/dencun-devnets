...
terraform {
  backend "s3" {
    ...
    key                         = "infrastructure/4844-devnet-p/terraform.tfstate"
  }
}
...
variable "digitalocean_vm_groups" {
  ...
  default = [
    ...
    },
    {
      id = "lighthouse-geth"
      vms = {
        "1" = { ansible_vars : "validator_start=1125 validator_end=1350" }
      },
    },
  ]
}
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "../../ansible/inventories/devnet-p/inventory.ini"
}
